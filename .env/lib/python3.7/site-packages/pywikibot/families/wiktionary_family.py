...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'eu', 'uk', 'br', 'skr', 'ast', 'da', 'lo', 'simple', 'bn', 'is', 'la',
        'hr', 'fj', 'tg', 'ky', 'sk', 'bg', 'wa', 'ur', 'ps', 'cy', 'vo',
        'shn', 'sl', 'he', 'af', 'zh-min-nan', 'scn', 'om', 'tl', 'pa', 'sw',
        'fy', 'nn', 'ka', 'lv', 'sq', 'min', 'nds', 'co', 'mn', 'ms', 'pnb',
        'lb', 'bs', 'nah', 'yue', 'mnw', 'sa', 'kk', 'km', 'diq', 'vec', 'be',
        'tk', 'mk', 'sm', 'hsb', 'shy', 'nia', 'gd', 'ga', 'an', 'wo', 'mni',
        'ks', 'gom', 'mr', 'su', 'ia', 'ang', 'mt', 'fo', 'tt', 'sd', 'gn',
